...
public class Assignment3Q4 {
    ...
    public static void main(String[] args) 
    {
    	...
    	DateClass one=new DateClass(27,3,2000);
    	DateClass two=new DateClass(27,3,1981);
    	DateClass three=new DateClass(7,7,1977);
    	DateClass four=new DateClass(5,8,2002);
    	...
    	String employeeName="PK,SK,RK,KJ";
