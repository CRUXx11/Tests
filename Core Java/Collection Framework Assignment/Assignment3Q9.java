...
public class Assignment3Q9 {
	public static void main(String[] args) {
		...
		SavingAccount sAccount1 = new SavingAccount(1000.74, 3, "PK", true);
		SavingAccount sAccount2 = new SavingAccount(533.23, 1, "RK", false);
		SavingAccount sAccount3 = new SavingAccount(3253.90, 2, "SK", true);
