...
class ChatApplication {
	...
	public void createChatroom() {
		...
		chatroom1.addUsername("PK");
		chatrooms.put("Chat", chatroom1);

	}

	public void addNewUser() {
		User user1 = new User("PK", "123", "PK", "KO");
		User user2 = new User("SK", "123", "SK", "KO");
		User user3 = new User("RK", "123", "RK", "Kadam");
